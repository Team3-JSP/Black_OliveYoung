...
반품, 환불 관련 내용은 고객센터로 별도 문의해주세요."></textarea> 
	...
	<div class="btn_area">
				...
				<button type="button" class="btn color1 gdasWriteLayer">닫기</button>
					...
					<button type="button" class="btn color3" id="btnGdasReg" onclick="mypage.gdasForm.handleClickGdasRegButton({t_click: '리뷰작성_리뷰등록하기', goodsNo: 'A000000147882', goodsname: '필리밀리 듀얼 면봉 200P', gdasSctType: '10'})" disabled="" data-attr="리뷰작성^리뷰등록^리뷰등록하기 버튼">리뷰 등록 하기</button>
...
<form name="gdasForm" id="gdasForm">
	...
	<input type="hidden" name="retUrl" id="retUrl" value="https://www.oliveyoung.co.kr/store/mypage/getGdasList.do?pageIdx=1&amp;reviewWriteType=monthly_use_review"> 
	...
	<input type="hidden" name="ordGoodsSeq" id="ordGoodsSeq" value="5">
	...
	<input type="hidden" name="orgGdasSeq" id="orgGdasSeq" value="23152495">
	<input type="hidden" name="renewUsed1mmGdasYn" id="renewUsed1mmGdasYn" value="Y">
</form>
<script type="text/javascript" src="https://static.oliveyoung.co.kr/pc-static-root/js/mypage/gdas.js?dumm=202312210002"></script>
